...
export const CategoryPills = () => {
  ...
  return (
    <section id="categories" data-testid="category-section" className="max-w-[1200px] mx-auto px-4 sm:px-6 pt-12 sm:pt-16">
      <Reveal className="flex items-end justify-between mb-5">
        <div>
          <p className="font-body text-[11px] tracking-[0.28em] uppercase text-graphite">Shop by</p>
          <h2 className="font-display font-bold text-base md:text-lg text-ink mt-1">Category</h2>
        </div>
          ...
          return (
            ...
            >
              <span className={`relative rounded-full p-[3px] transition-[border-color,transform] duration-300 border-2 ${active ? "border-brand scale-105" : "border-gold/80 group-hover:border-gold"}`}>
                <span className="block w-[62px] h-[62px] sm:w-[88px] sm:h-[88px] rounded-full overflow-hidden bg-subtle">
